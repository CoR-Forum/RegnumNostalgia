...
- **Quickbar**: 4 rows × 10 slots for quick item use; drag items from inventory to add, drag between slots to move/swap, drag outside to remove; scroll between rows with mouse wheel or arrow buttons, keyboard shortcuts (1-0); persisted in database
