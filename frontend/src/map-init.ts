...
import { setMapState, setTerritoryIcons, positionsToLatLngs, setRasterCoords, gameToLatLng, latLngToGame, GAME_SIZE } from './map-state';
import './rastercoords'; // registers L.RasterCoords on the global L
